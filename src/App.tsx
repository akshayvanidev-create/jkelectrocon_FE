    ...
    <>
      ...
      <div className="min-h-screen selection:bg-blue-500 selection:text-white bg-[#050B1F]">
        ...
        >
          ...
          <nav className="hidden lg:flex gap-6 lg:gap-12 text-[11px] font-bold uppercase tracking-[0.4em] text-white/50">
            <a
              ...
              className="hover:text-white hover:tracking-[0.5em] transition-all duration-500"
            >
              Portfolio
            </a>
            <a
        ...
        <a
          ...
          className="fixed bottom-8 right-8 z-[60] w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-300"
        >

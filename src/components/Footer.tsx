    ...
    <footer className="py-16 md:py-20 bg-gradient-to-b from-[#0A1229] to-[#050B1F] border-t border-white/10">
      <div className="max-w-screen-2xl mx-auto px-4 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 md:gap-16 mb-16">
          ...
          <div className="lg:col-span-5">
            <div className="flex items-center gap-3 md:gap-4 mb-6">
              <img src="/assets/brand-logo.jpeg" alt="JK Electrocon" className="h-10 md:h-12 w-auto object-contain" />
            ...
            <div className="space-y-3 text-sm md:text-base">
              <a href="mailto:concierge@jkelectrocon.com" className="flex items-center gap-3 text-muted hover:text-white transition-colors group">
                ...
                <span>concierge@jkelectrocon.com</span>
              </a>
              <a href="tel:+919810000000" className="flex items-center gap-3 text-muted hover:text-white transition-colors group">
                <div className="w-10 h-10 rounded-full bg-blue-500/10 border border-blue-500/20 flex items-center justify-center group-hover:bg-blue-500/20 group-hover:border-blue-500/40 transition-all">
                  <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-2">
            <h4 className="text-xs md:text-sm font-black uppercase tracking-widest mb-6 text-blue-400">Explore</h4>
            <ul className="space-y-3 text-sm md:text-base">
              <li><a href="#solutions" className="text-muted hover:text-white hover:translate-x-1 inline-block transition-all duration-300">Solutions</a></li>
              <li><a href="#portfolio" className="text-muted hover:text-white hover:translate-x-1 inline-block transition-all duration-300">Technology Partners</a></li>
              <li><a href="#contact" className="text-muted hover:text-white hover:translate-x-1 inline-block transition-all duration-300">Contact Us</a></li>
              <li><a href="#" className="text-muted hover:text-white hover:translate-x-1 inline-block transition-all duration-300">Case Studies</a></li>
            </ul>
          </div>
          
          {/* Partners Section */}
          <div className="lg:col-span-5">
            <h4 className="text-xs md:text-sm font-black uppercase tracking-widest mb-6 text-blue-400">Technology Partners</h4>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 text-xs md:text-sm">
          <p className="text-muted">© 2026 JK Electrocon. All rights reserved.</p>
          <div className="flex items-center gap-8">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-8 h-8 rounded-full bg-white/5 hover:bg-blue-500 border border-white/10 hover:border-blue-500 flex items-center justify-center transition-all duration-300 group">

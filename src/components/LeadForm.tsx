...
const LeadForm: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="contact"
      className="py-12 md:py-20 px-4 md:px-12 lg:px-20 bg-[#050B1F] relative"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-24 items-start">
          ...
          <div className="contact-info space-y-8 md:space-y-16 gsap-reveal">
            <div className="space-y-4 md:space-y-6">
              <h2 className="text-xs md:text-sm uppercase tracking-[0.4em] md:tracking-[0.6em] text-blue-500 font-black">
                Concierge
              </h2>
              <h3 className="text-2xl sm:text-4xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-none">
                Start Your <br />
                <span className="text-white/30 italic font-light">
                  Journey.
                </span>
              </h3>
              <p className="text-muted text-sm md:text-lg lg:text-xl font-light max-w-md pt-2 md:pt-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-12">
              <div className="space-y-4 group cursor-default">
                <h4 className="text-xs font-black uppercase tracking-widest text-blue-500/60 group-hover:text-blue-500 transition-colors">
                  Headquarters
                </h4>
                <p className="text-sm sm:text-lg text-muted font-light leading-relaxed group-hover:text-white transition-colors">
              ...
              {status === "success" ? (
                <div className="text-center py-20 animate-fade-in space-y-10">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-muted text-sm sm:text-lg font-light max-w-xs mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-10">
                  <div className="space-y-8">
                    ...
                    <div className="relative group/field">
                      <label className="text-[10px] font-black uppercase tracking-widest text-blue-500/60 mb-2 block group-focus-within/field:text-blue-500 transition-colors">
                        Client Identity
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-2xl py-3 px-4 focus:outline-none focus:border-blue-500 focus:bg-white/[0.08] focus:ring-4 focus:ring-blue-500/10 transition-all placeholder:text-white/10 text-base sm:text-lg font-light text-white"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="relative group/field">
                        ...
                        <input
                          ...
                          required
                          placeholder="+91 ...."
                          className="w-full bg-white/5 border border-white/10 rounded-2xl py-3 px-4 focus:outline-none focus:border-blue-500 focus:bg-white/[0.08] transition-all placeholder:text-white/10 text-base sm:text-lg font-light text-white"
                        />
                      </div>
                      <div className="relative group/field">
                        <label className="text-[10px] font-black uppercase tracking-widest text-blue-500/60 mb-2 block group-focus-within/field:text-blue-500 transition-colors">
                    ...
                    <div className="relative group/field">
                      ...
                      <select
                        required
                        className="w-full bg-white/5 border border-white/10 rounded-2xl py-3 px-4 focus:outline-none focus:border-blue-500 focus:bg-white/[0.08] transition-all appearance-none text-base sm:text-lg font-light text-white cursor-pointer"
                      >
                        <option
                          value=""
                          disabled
                        ...
                        <option value="automation" className="bg-[#050B1F]">
                          Smart Home Ecosystem
                        </option>
                        <option value="theatre" className="bg-[#050B1F]">
                          Private Cinema & Hi-Fi
                        </option>
                        <option value="security" className="bg-[#050B1F]">
                          Advanced Bio-Security
                        </option>
                        <option value="climate" className="bg-[#050B1F]">
                          Pure Air & Climate
                        </option>
                      </select>
